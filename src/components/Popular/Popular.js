...
function Popular() {
  return (
    <div className='popular'>
        ...
        <div className='polaroid'>
            ...
            <div class="caption">pink puff sleeve mini frock
             <p>$ 450</p>
             <button>Add to Cart</button> 
            </div>
  </div>
        <div className='polaroid'>
            <img src="https://ae01.alicdn.com/kf/Se5b0b8799f6f40f69d072dbbfbef8deaX/Bohemian-Style-Solid-Color-Green-Female-s-Denim-Shirts-Lantern-Sleeve-Rivet-Loosen-Fit-Jeans-Tops.jpg" alt="" width="50%"/>
            <div class="caption">Lantern sleeve Rivet Loosen Fit
             <p>$ 350</p>
             <button>Add to Cart</button> 
            </div>
  </div> 
        <div className='polaroid'>
            <img src="https://shopchrome.com/cdn/shop/products/ACT17492SL_BLUE_2_1200x_8b6995f5-71c1-46e9-a056-aa6ed342193a.webp?v=1681922175" alt="" width="50%"/>
            <div class="caption">blue puff sleeve top
             <p>$ 300</p>
             <button>Add to Cart</button> 
            </div>
  </div> 
        <div className='polaroid'> 
            ...
            <div class="caption">puff sleeves jeans shirt
             <p>$ 500</p>
             <button>Add to Cart</button> 
            </div>
  </div> 
  <div className='polaroid'> 
            ...
            <div class="caption">V-Neck Full Pleated Skirt Dresses
             <p>$ 1000</p>
            <button>Add to Cart</button> 
            </div>
  </div> 
  <div className='polaroid'> 
            ...
            <div class="caption">Wine Red Floral Print Mulmul Sleeveless Kurta Set
             <p>$ 1399</p>
             <button>Add to Cart</button> 
            </div>
  </div> 
  <div className='polaroid'> 
            ...
            <div class="caption">Printed Sleeveless Top
             <p>$ 1000</p>
              <button>Add to Cart</button> 
            </div>
  </div>
  <div className='polaroid'> 
            ...
            <div class="caption">White Glittering Top 
            <p>$ 1399</p>
             <button>Add to Cart</button> 
            </div>
  </div>  
